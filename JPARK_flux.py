...
class JPARCMLFBeamConfig:
    """J-PARC MLF benchmark beam metadata for semi-analytic DAR estimates."""
...
MODEL = StoppedPionDARFluxModel(
    ...
    file_prefix="jparc",
    beam_factory=JPARCMLFBeamConfig,
)
...
def differential_flux_delayed(E_MeV, distance_m: float, flavor: str, beam: JPARCMLFBeamConfig | None = None):
    return MODEL.differential_flux_delayed(E_MeV, distance_m, flavor, beam=beam)


def differential_fluence_delayed_per_pot(E_MeV, distance_m: float, flavor: str, beam: JPARCMLFBeamConfig | None = None):
    return MODEL.differential_fluence_delayed_per_pot(E_MeV, distance_m, flavor, beam=beam)


def binned_prompt_numu_flux(E_edges_MeV, distance_m: float, beam: JPARCMLFBeamConfig | None = None):
    return MODEL.binned_prompt_numu_flux(E_edges_MeV, distance_m, beam=beam)


def binned_prompt_numu_fluence_per_pot(E_edges_MeV, distance_m: float, beam: JPARCMLFBeamConfig | None = None):
    return MODEL.binned_prompt_numu_fluence_per_pot(E_edges_MeV, distance_m, beam=beam)


def total_differential_flux(E_MeV, distance_m: float, beam: JPARCMLFBeamConfig | None = None):
    return MODEL.total_differential_flux(E_MeV, distance_m, beam=beam)


def total_differential_fluence_per_pot(E_MeV, distance_m: float, beam: JPARCMLFBeamConfig | None = None):
    return MODEL.total_differential_fluence_per_pot(E_MeV, distance_m, beam=beam)


def binned_total_flux(E_edges_MeV, distance_m: float, beam: JPARCMLFBeamConfig | None = None):
    return MODEL.binned_total_flux(E_edges_MeV, distance_m, beam=beam)


def binned_total_fluence_per_pot(E_edges_MeV, distance_m: float, beam: JPARCMLFBeamConfig | None = None):
